...
interface IronCordAPI {
  ...
  react: (target: string, msgId: string, reaction: string) => Promise<void>;
  onIRCReaction: (callback: (data: { nick: string; target: string; msgId: string; reaction: string }) => void) => void;
